...
<output style="color: dodgerblue;background: #f5f5f5;display: inline-block;padding: 1em 4em 1em 1em;border-radius: 5px;"></output>
    ...
    <script>
      const map = {
        0: '/${secretPath}/visitors?range=second',
        1: '/${secretPath}/visitors?range=minute',
        2: '/${secretPath}/visitors?range=hour',
        3: '/${secretPath}/visitors?range=day',
        4: '/${secretPath}/visitors?range=week',
        5: '/${secretPath}/visitors?range=month',
        6: '/${secretPath}/visitors?range=year',
        7: '/${secretPath}/visitors?all'
      }
